...
So we've filled the screen and we've only used 2 of our 60 dimensions. 

Our current, best representation manages to encode 12 dimensions of data before the GPU maxes out and our laptop heats to 220 degrees:
